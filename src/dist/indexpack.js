...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;/*==================================================
	 ...
	 avalon.shim.js(无加载器版本) 1.4.7.2 built in 2016.9.12
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "* {\n  margin: 0;\n  padding: 0;\n  box-sizing: border-box;\n  font-family: 'Microsoft Sans Serif'; }\n\nli {\n  list-style: none; }\n\nselect, button {\n  color: #bbbbbb; }\n\nbody {\n  color: #bbbbbb;\n  font-size: 14px;\n  width: 100%;\n  height: 100%;\n  overflow: hidden;\n  position: relative;\n  z-index: -99; }\n\na {\n  text-decoration: none; }\n\nhtml {\n  width: 100%;\n  height: 100%; }\n\nbutton {\n  outline: none;\n  border: none;\n  border-radius: 4px;\n  color: #fff;\n  text-align: center; }\n\n.clearfix {\n  zoom: 1; }\n  .clearfix:after {\n    content: \"\";\n    height: 0;\n    display: block;\n    clear: both;\n    visibility: hidden; }\n\n.theme2 {\n  background-color: #e6e6e6 !important;\n  color: #000; }\n\n.nav_bar {\n  background-color: #3c3f41;\n  height: 25px;\n  border-bottom: 1px #282828 solid;\n  width: 100%; }\n  .nav_bar .nav_bar_left {\n    height: 25px;\n    float: left; }\n    .nav_bar .nav_bar_left .nav_bar_item {\n      float: left;\n      line-height: 25px;\n      position: relative;\n      perspective: 500px; }\n      .nav_bar .nav_bar_left .nav_bar_item:hover .nav_bar_text {\n        width: 200px;\n        color: #fff;\n        background-color: #2f65ca; }\n      .nav_bar .nav_bar_left .nav_bar_item:hover .nav_bar_wrapper {\n        transition: all 1.2s;\n        transform: rotateX(360deg);\n        opacity: 1; }\n      .nav_bar .nav_bar_left .nav_bar_item .nav_bar_text {\n        text-align: center;\n        transition: all .6s;\n        width: 120px; }\n      .nav_bar .nav_bar_left .nav_bar_item .nav_bar_wrapper_theme2 {\n        background-color: #e6e6e6 !important; }\n      .nav_bar .nav_bar_left .nav_bar_item .nav_bar_wrapper {\n        transform-style: preserve-3d;\n        transform-origin: 0 0 0;\n        transform: rotateX(-90deg);\n        font-size: 12px;\n        border-radius: 5px;\n        position: absolute;\n        top: 24px;\n        left: 0;\n        opacity: 0;\n        width: 200px;\n        background-color: #3c3f41;\n        border: 1px solid #646464; }\n        .nav_bar .nav_bar_left .nav_bar_item .nav_bar_wrapper .nav_content_item {\n          text-indent: 2em; }\n          .nav_bar .nav_bar_left .nav_bar_item .nav_bar_wrapper .nav_content_item:first-child {\n            border-bottom: 1px solid #646464; }\n          .nav_bar .nav_bar_left .nav_bar_item .nav_bar_wrapper .nav_content_item:last-child {\n            border-top: 1px solid #646464; }\n          .nav_bar .nav_bar_left .nav_bar_item .nav_bar_wrapper .nav_content_item:hover {\n            background-color: #2f65ca; }\n  .nav_bar .nav_bar_right {\n    float: right;\n    margin-right: 20px;\n    height: 25px; }\n    .nav_bar .nav_bar_right .nav_bar_item {\n      cursor: pointer;\n      transition: all 1s;\n      float: left;\n      margin-top: 6px;\n      margin-right: 10px;\n      font-size: 12px;\n      width: 12px;\n      height: 12px;\n      border-radius: 12px;\n      text-align: center;\n      line-height: 12px; }\n      .nav_bar .nav_bar_right .nav_bar_item:hover {\n        border-radius: 0;\n        transform: scale(1.5); }\n    .nav_bar .nav_bar_right .theme1 {\n      color: #fff;\n      background-color: #000; }\n    .nav_bar .nav_bar_right .theme2 {\n      color: #000;\n      background-color: #fff; }\n\n.search_bar {\n  height: 40px;\n  background-color: #3c3f41;\n  border-bottom: 1px #282828 solid;\n  overflow: hidden; }\n  .search_bar .search_bar_input {\n    margin-left: 20px;\n    width: 200px;\n    transition: all 1s;\n    padding: 0 20px;\n    margin-top: 10px;\n    outline: none;\n    border: 1px solid #646464;\n    height: 20px;\n    background-color: #45494a;\n    border-radius: 14px; }\n    .search_bar .search_bar_input:focus {\n      width: 400px; }\n  .search_bar .search_bar_text {\n    font-size: 12px;\n    line-height: 40px;\n    color: #bbbbbb; }\n  .search_bar .search_bar_btn {\n    float: right;\n    color: #bbbbbb;\n    background-color: #45494a;\n    border-radius: 2px;\n    border: 1px solid #282828;\n    width: 65px;\n    height: 20px;\n    margin-top: 10px;\n    margin-right: 20px; }\n    .search_bar .search_bar_btn:hover {\n      background-color: #2f65ca; }\n  .search_bar .search_select_wrapper {\n    float: right; }\n  .search_bar .search_bar_theme {\n    margin-right: 30px;\n    margin-top: 10px;\n    float: right;\n    outline: none;\n    background-color: #3c3f41;\n    border: 1px solid #282828;\n    font-size: 14px; }\n\n.file_tree_bar {\n  z-index: -1;\n  transition: all .6s;\n  width: 200px;\n  position: absolute;\n  top: 65px;\n  bottom: 25px;\n  left: 0;\n  background-color: #3c3f41;\n  overflow: scroll; }\n\n.code_edit_bar {\n  transition: all 1s;\n  z-index: -1;\n  position: absolute;\n  top: 65px;\n  bottom: 25px;\n  left: 200px;\n  right: 0;\n  background-color: #2b2b2b;\n  overflow: scroll; }\n  .code_edit_bar .CodeMirror {\n    height: 100%;\n    width: 100%; }\n  .code_edit_bar .code_edit_max {\n    cursor: pointer;\n    border: 4px #3c3f41 solid;\n    border-radius: 5px;\n    position: absolute;\n    width: 20px;\n    height: 40px;\n    bottom: 0;\n    left: -4px;\n    z-index: 999;\n    word-wrap: break-word;\n    text-align: center;\n    font-size: 12px;\n    padding: 4px 0; }\n  .code_edit_bar .code_edit_max_theme2 {\n    border: 4px #e6e6e6 solid;\n    color: #000; }\n\n.code_edit_max {\n  left: 0px; }\n\n.foot_status_bar {\n  position: absolute;\n  height: 25px;\n  background-color: #3c3f41;\n  border-top: #282828 1px solid;\n  left: 0;\n  bottom: 0;\n  width: 100%;\n  line-height: 25px;\n  font-size: 12px;\n  text-align: right; }\n  .foot_status_bar .foot_status_title {\n    font-weight: bold;\n    color: #fff; }\n  .foot_status_bar .foot_status_title_theme2 {\n    color: #000 !important; }\n\n.input_bar {\n  transition: all 1s;\n  transform-style: preserve-3d;\n  transform-origin: 0 0 0;\n  transform: rotateX(90deg);\n  opacity: 0;\n  z-index: 999;\n  height: 100px;\n  width: 600px;\n  background-color: #2b2b2b;\n  border-radius: 5px;\n  position: fixed;\n  left: 50%;\n  margin: 100px 0 0 -300px;\n  border: 5px solid #3c3f41;\n  font-size: 16px; }\n  .input_bar .input_bar_title {\n    width: 100%;\n    text-align: center;\n    height: 30px;\n    line-height: 30px;\n    border-bottom: 2px solid #3c3f41; }\n  .input_bar input {\n    transition: all 1s;\n    margin-top: 15px;\n    font-size: 16px;\n    height: 30px;\n    width: 250px;\n    outline: none;\n    border: 1px solid #646464;\n    background-color: #3c3f41;\n    padding: 0 20px;\n    margin-left: 50px; }\n    .input_bar input:focus {\n      border-radius: 15px;\n      width: 500px; }\n  .input_bar button {\n    position: absolute;\n    transition: all .3s;\n    margin-top: 60px;\n    width: 65px;\n    height: 30px;\n    background-color: #3c3f41;\n    right: 30px;\n    bottom: -30px;\n    opacity: .3; }\n    .input_bar button:hover {\n      opacity: 1; }\n  .input_bar .input_bar_select {\n    position: absolute;\n    left: 20px;\n    top: 5px;\n    height: 20px;\n    width: 65px;\n    font-size: 12px;\n    outline: none;\n    background-color: #3c3f41;\n    border: 1px solid #282828; }\n\n.input_bar_active {\n  transform: rotateX(360deg);\n  opacity: 1; }\n", ""]);
